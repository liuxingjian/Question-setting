package com.example.ruanjian01.GUITest;

import com.example.ruanjian01.DrawDraw;
import com.example.ruanjian01.ExerciseTest.BinaryOperation;
import com.example.ruanjian01.ExerciseTest.Exercise;
import com.example.ruanjian01.ExerciseTest.ExerciseIOException;
import com.example.ruanjian01.ExerciseTest.score;
import com.example.ruanjian01.HelloApplication;
import com.example.ruanjian01.helloapp;
...
public class PracticeGui2<Answers> extends JFrame {
    ...
    static final int OP_AMOUNT = 50;
    static final int OP_COLUMN = 5;
    static final int OP_WIDTH = 140;
    ...
    JButton button_9=new JButton("成绩");
    JButton button_10=new JButton("草稿纸");
    JButton button_11=new JButton("计算器");
